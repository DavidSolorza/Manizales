      ...
      <div className="max-w-2xl mx-auto px-4 py-6">
        ...
        {user && user.role === 'ESTUDIANTE' ? (
          <div className="text-center py-16 animate-fade-in">
            ...
            <p className="text-tinta font-medium">Solo los arrendadores pueden publicar</p>
            <p className="text-sm text-sec mt-1">Si queres publicar un lugar, cambia tu rol desde la configuracion</p>
          </div>
        ) : (
          <>
